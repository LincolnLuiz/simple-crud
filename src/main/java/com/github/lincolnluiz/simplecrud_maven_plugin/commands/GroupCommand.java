...
import com.github.lincolnluiz.simplecrud_maven_plugin.exception.GroupNotFound;
...
public class GroupCommand {
	...
	public void ls() {
		...
		List<Group> groups = groupsOptional.orElseThrow(GroupNotFound::new);
	...
	public void show(String groupTitle) {
		...
		Group group = groupOptional.orElseThrow(GroupNotFound::new);
